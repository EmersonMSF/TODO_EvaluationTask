...
// export const MenuItems = ['Dashboard', 'Products']
...
export const CARD_ID_CONSTANT = "PCID"
...
export const CARD_ITEMID_CONSTANT = "CID"
export const USER_ID_CONSTANT = "UID"


export const API_URL = 'https://hplussport.com/api/products/order/price/sorc/qty/100'

export const PRODUCT_TABLEHEADERS = ['S.No', 'Order ID', 'Product Name', 'Description', 'Price']
export const PRODUCT_TABLE_MAXDATA = 8;
